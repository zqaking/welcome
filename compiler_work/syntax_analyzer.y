...
%token <node> ADD SUB MUL DIV LT GT ASSIN LTE GTE EQ NEQ
...
type_specifier fun_declaration params param_list param compound_stmt local_declarations
...
addop term mulop factor integer float call args arg_list
...
fun_declaration
: type_specifier IDENTIFIER LPARENTHESE params RPARENTHESE compound_stmt
{
